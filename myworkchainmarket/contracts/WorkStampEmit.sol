...
contract WorkStampEmit {
    ...
    event StampLogging(address _userId, uint _latitude, uint _longitude, uint256 _timestamp);
    ...
    function checkStamp(address _userId, uint _yearMon, uint _day, uint _workCode, 
        ...
        emit StampLogging(_userId, _latitude, _longitude, entry.timestamp);
    }
